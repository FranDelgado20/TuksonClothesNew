...
const includedFeatures = [
  ...
  "Sumar mas puntos con cada compra",
  "Ser cliente exclusivo de Tukson Clothes",
];
const Subs = () => {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            En Tukson Clothes creemos que estar a la moda es indispensable para
            el día a día por eso te traemos esta solución
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt-6 text-base leading-7 text-gray-600">
              Con esta suscripción tendrás una prenda aleatoria gratis cada més,
              que llegará a la puerta de tu casa sin cósto
            </p>
